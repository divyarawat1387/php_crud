...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <?php
        ...
        ?>
    <a class="navbar-brand" href="index.html">Welcome <?php echo $_SESSION["email"]; ?> </a>
    <?php
        }
        else 
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Article">
          ...
          <ol>
            <a class="nav-link" href="article_list.php">
              <i class="fa fa-fw fa-area-chart"></i>
              <span class="nav-link-text">Article List</span>
            </a>
          </ol>
          <ol>
